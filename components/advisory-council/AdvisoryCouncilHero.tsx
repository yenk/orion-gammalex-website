...
export default function AdvisoryCouncilHero() {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(/images/advisory/hero-background.png)',
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-6 sm:px-8 lg:px-12 py-20 sm:py-24 lg:py-32">
        ...
        >
          ...
          >
            Industry leaders and healthcare experts guiding GammaLex's mission to transform clinical compliance through responsible AI.
          </motion.p>
        </motion.div>
      </div>
    </section>
