      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-gammalex-purple mb-6">
              The ROI?
            </h3>
