      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h3 className="text-2xl sm:text-3xl font-semibold text-white mb-6">
            Ready to transform your pre-authorization process?
          </h3>
          <p className="text-lg text-white/90 leading-relaxed max-w-3xl mx-auto">
            Join healthcare organizations already using GammaLex to streamline their pre-authorization workflows and improve patient care.
          </p>
        </motion.div>
      </div>
    </section>
