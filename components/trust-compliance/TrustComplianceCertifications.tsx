...
export default function TrustComplianceCertifications() {
  return (
    <section className="w-full py-20 sm:py-24 px-4 sm:px-6 lg:px-8 font-inter bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-semibold text-white">SOC 2 Type II in progress</h3>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-semibold text-white">Data Privacy Framework in progress</h3>
            <p className="text-lg text-white/90 leading-relaxed">
