          ...
          >
            ...
            <div className="max-w-5xl mx-auto">
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <p className="text-xl sm:text-2xl md:text-3xl font-inter text-white/90 leading-relaxed text-center mb-6">
                  To defend care—before it's questioned, delayed, or denied.
                </p>
                <p className="text-lg sm:text-xl md:text-2xl font-inter text-white/80 leading-relaxed text-center">
...
function Navigation() {
  ...
  const navItems = [
    { id: "the-mission", label: "WHY GAMMALEX" },
              ...
              <div className="flex items-center space-x-32">
                {navItems.map((item) => (
                  ...
                  <motion.button
                        ...
                        {/* Dropdown Menu */}
                        <AnimatePresence>
                          {item.id === 'problems-we-solve' && isWhatWereSolvingDropdownOpen && (
                            <motion.div
        ...
        <>
          <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-8 mt-2">
            {[{
              ...
              <div key={idx} className="bg-white/5 rounded-2xl p-8 border border-gammalex-orange/30 flex flex-col justify-center min-h-[170px] group transition-all duration-200 hover:border-gammalex-orange hover:shadow-lg">
      ...
      content: (
        <ul className="space-y-6 mt-2">
          {[
            ...
            <li key={idx} className="flex items-start gap-4 text-white/90 text-xl sm:text-2xl font-inter">
